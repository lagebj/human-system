...
- `AGENTS.md` (bootloader only)
- `.agents/skills/human-systems-context/SKILL.md` (routing and source selection)
...
- `.agents/skills/human-systems-context/resources/playbooks/book-manuscript-workflow.md`
...
## Stale or Deprecated Files

- `.agents/skills/human-systems-context/resources/source/book_work/human.md` — 33,952 words, stale snapshot from earlier draft. Do not edit.
- `manuscript/drafts/` — Historical drafts, preserved for reference only
- `inbox/` — Unverified notes, non-canonical until deliberately promoted
